...
public class RecyclerViewAdapterExploreRandom extends RecyclerView.Adapter<RecyclerViewAdapterExploreRandom.MyViewHolder>{

    private Context mContext;
    private List<PlaylistDataRandom> playlistDataListRandom;
    FragmentManager fragmentManager;

        public RecyclerViewAdapterExploreRandom(Context mcontext, List<PlaylistDataRandom> playlistDataListRandom,FragmentManager fragmentManager) {
        this.mContext = mcontext;
        this.playlistDataListRandom = playlistDataListRandom;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ımageViewAddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("Uid",playlistDataListRandom.get(position).getUid());
                bundle.putString("PlaylistName",playlistDataListRandom.get(position).getPlaylistname());
    ...
    public int getItemCount() {
        return playlistDataListRandom.size();
    }
